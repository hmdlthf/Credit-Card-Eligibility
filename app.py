...
if pilihan == 'Prediksi dari file csv':
    ...
    if upload_file is not None:
        ...
        for i in range(len(hasil)):
            if hasil[i] == 1:
                st.write('Data pelanggan',dataku['ID'][i],'= diprediksi Layak untuk daftar Credit Card')
            else:
                st.write('Data pelanggan',dataku['ID'][i],'= diprediksi Tidak Layak untuk daftar Credit Card')
    else:
